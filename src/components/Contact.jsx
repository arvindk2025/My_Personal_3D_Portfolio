...
const Contact = () => {
  ...
  const handleSubmit = (e) =>{
    ...
    emailjs.send(
       ...
       {
        from_name:form.name,
        to_name:'ARVIND KUMAR',
        from_email: form.email,
        to_email:'arvindkumar2414595@gmail.com',
    ...
    >
      ...
      >
        ...
        >
          ...
          <button 
              type="submit"
              className="bg-pink-600 hover:bg-pink-700 py-3 px-8 rounded-xl outline-none w-fit text-white font-extrabold shadow-md shadow-primary"
            >
